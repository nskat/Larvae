...
#singularity exec --writable -H $HOME:/home/$USER -B /pasteur/projets/policy02/Larva-Screen/screens/:/screen tensorflow_gpu.img/ python /Larvae/loader.py /screen --save_dir=/Larvae/tests --lines=MZZ_R_3013849@UAS_Chrimson_Venus_X_0070
...
def load_transform(path, labels='normal', lines=None, save_dir=''):
    ...
    # feats = ['larva_length_deriv_smooth_5', 'S_deriv_smooth_5', 'eig_deriv_smooth_5', 'angle_upper_lower_deriv_smooth_5',
    #          'angle_downer_upper_deriv_smooth_5', 'd_eff_head_norm_deriv_smooth_5', 'd_eff_tail_norm_deriv_smooth_5',
    #          'motion_velocity_norm_smooth_5', 'head_velocity_norm_smooth_5', 'tail_velocity_norm_smooth_5',
    #          'motion_to_u_tail_head_smooth_5', 'motion_to_v_tail_head_smooth_5']
        ...
        for i, file_ in enumerate(allFiles):
            ...
            if len(df.index) > 250:
                ...
                for col in feats:
                    ...
                    tau = np.logspace(np.log10(5 * Ts), np.log10(taumax), 10)  # using 10 points on a logscale
